...
class StudentClient {
	public static void main(String[] args) throws Exception {
		...
		cfg = cfg.configure("hibernate.level1.cfg.xml");
...
//		 ses1.beginTransaction();
		...
		/**
		 * When ever we need to remove any persistent state object explicitly
		 * from our level 1 cache then we can call evict(_) method belongs to
		 * session object
		 */
//		 ses1.evict(st1);
		st1 = (StudentBean) ses1.get(StudentBean.class, new Integer(1));
